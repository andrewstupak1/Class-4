...
# dig through bitcoint_data to find conversion rate (rate_float) 
...
# multiply the conversion rate by the numner of bitcoin
value_of_users_bitcoin = bitcoin * conversion_rate

# wrtie the value of the user's bitcoin on screen
